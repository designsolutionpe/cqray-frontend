                        ...
                        <template #content>
                            <div class="flex items-center mb-0">
                                ...
                                <div class="col-span-8 flex justify-center flex-col pl-4">
                                    ...
                                    <span class="block text-2xl font-bold text-primary dark:text-white/90">{{ nSedesCount }}</span>
                                </div>
                            </div>
                        </template>
                    </Card>
                        ...
                        <template #content>
                            <div class="flex items-center mb-0">
                                ...
                                <div class="col-span-8 flex justify-center flex-col pl-4">
                                    ...
                                    <span class="block text-2xl font-bold text-secondary dark:text-white/90">{{ nCitasCount }}</span>
                                </div>
                            </div>
                        </template>
                    </Card>
                        ...
                        <template #content>
                            <div class="flex items-center mb-0">
                                ...
                                <div class="col-span-8 flex justify-center flex-col pl-4">
                                    ...
                                    <span class="block text-2xl font-bold text-secondary dark:text-white/90">{{ nPacientesCount }}</span>
                                </div>
                            </div>
                        </template>
                    </Card>
                    ...
                    <template #content>
                        <div class="flex items-center mb-0">
                            ...
                            <div class="col-span-8 flex justify-center flex-col pl-4">
                                ...
                                <span class="block text-2xl font-bold text-primary dark:text-white/90">{{ nPagosCount }}</span>
                            </div>
                        </div>
                    </template>
                </Card>
                    ...
                    <template #content>
                        <div class="flex items-center mb-0">
                            ...
                            <div class="col-span-8 flex justify-center flex-col pl-4">
                                ...
                                <span class="block text-2xl font-bold text-secondary dark:text-white/90">{{ nReportesCount }}</span>
                            </div>
                        </div>
                    </template>
                </Card>
