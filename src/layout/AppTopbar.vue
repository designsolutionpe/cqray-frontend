...
const onLogoutOpen = () => yesNoDialog.value.showDialog()
...
<template>
    <div>
        <div class="layout-topbar">
            <div class="layout-topbar-logo-container">
                ...
                <router-link to="/" class="layout-topbar-logo">
                    ...
                    -->
                    <img v-if="!isDarkTheme" src="/logo_ray.png" alt="Logo Ray" style="width: 120px; height: auto;">
                    <img v-else src="/logo_ray2.png" alt="Logo Ray" style="width: 120px; height: auto;">
                </router-link>
            </div>
                ...
                <div class="layout-topbar-menu hidden lg:block">
                    <div class="layout-topbar-menu-content">
                        ...
                        <button type="button" v-tooltip.bottom="'Perfil'" class="layout-topbar-action overflow-hidden"
                            @click="mostrarPerfil">
                            <Avatar v-if="!bImageError" :image="foto" class="hidden lg:block" shape="circle"
                                size="large"></Avatar>
                            <img class="hidden" :src="foto" alt="Perfil" @error="onImageError">
                            <i v-if="!bImageError" class="pi pi-user lg:hidden"></i>
                        ...
                        <button type="button" class="layout-topbar-action" @click="onLogoutOpen">
        ...
        <YesNoDialog ref="yesNoDialog" title="¿Desea salir del sistema?" :onAffirmation="logoutUser"></YesNoDialog>
    </div>
</template>
